...
<body>
  ...
  <h1 class='name'>Water Oak (Common Name)</h1>
  <h1>Coming Soon (Scientific Name)</h1>
  <p class='navLinks'>
  ...
  <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\niswonger_trail\waterOak\photo2.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\niswonger_trail\waterOak\photo3.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\niswonger_trail\waterOak\photo4.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\niswonger_trail\waterOak\photo5.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
