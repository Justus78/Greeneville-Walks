...
<body>
  ...
  <h1 class='name'>Panicle Hydrangea (Common Name)</h1>
  <h1>Hydrangea paniculata (Scientific Name)</h1>
  <p class='navLinks'>
  ...
  <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\niswonger_trail\panicleHydrangea\photo1.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\niswonger_trail\panicleHydrangea\photo2.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\niswonger_trail\panicleHydrangea\photo3.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\niswonger_trail\panicleHydrangea\photo4.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
