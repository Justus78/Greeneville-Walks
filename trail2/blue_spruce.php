...
<body>
  ...
  <h1 class='name'> Blue Spruce (Common Name)</h1>
  ...
  <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\trail_2_pics_and_vids\Blue Spruce 1.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\trail_2_pics_and_vids\Blue Spruce2.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\trail_2_pics_and_vids\Blue Spruce3..jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\trail_2_pics_and_vids\Blue Spruce4.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
