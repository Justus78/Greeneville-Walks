...
<head>
  <title>Snowball Hydrangea</title>
...
<body>
  ...
  <h1 class='name'> Snowball Hydrangea (Common Name)</h1>
  ...
  <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\trail_2_pics_and_vids\SNOWBALL HYDRANGEA 1. .jpg" class="d-block w-100" alt="...">
      </div>
    </div>
