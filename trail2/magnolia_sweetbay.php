...
<body>
  ...
  <h1 class='name'> Magnolia Sweetbay (Common Name)</h1>
  ...
  <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\trail_2_pics_and_vids\Magnolia Sweetbay1.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\trail_2_pics_and_vids\Magnolia Sweetbay2.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\trail_2_pics_and_vids\MagnoliaSweetbay3.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
