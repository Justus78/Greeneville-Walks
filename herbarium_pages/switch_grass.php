...
<body>
  ...
  <h1 class='name'>Switch Grass, Tall Panic Grass (Common Name)</h1>
  <h1>Panicum virgatum (Scientific Name)</h1>
   ...
   <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\herbarium_pics\IMG_0154.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0152.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0153.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
