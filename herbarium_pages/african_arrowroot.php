...
<body>
  ...
  <h1 class='name'>African Arrowroot, Indian Shot (Common Name)</h1>
  <h1>Canna indica (Scientific Name)</h1>
   ...
   <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\herbarium_pics\IMG_0129.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0123.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0127.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
