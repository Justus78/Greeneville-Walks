...
<head>
  <title>Common Morning Glory</title>
...
<body>
  ...
  <h1 class='name'>Common Morning Glory (Common Name)</h1>
  <h1>Ipomoea Purpurea (Scientific Name)</h1>
   ...
   <div id="carouselExampleIndicators" class="carousel slide w-25 mx-auto d-block">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="..\herbarium_pics\IMG_0146.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0142.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0143.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="..\herbarium_pics\IMG_0144.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
